...
void Timers::addInterruptTimer3(void (*timer3func) (void), int hz) {
    Timers::setTimer3func(timer3func);
    Timers::initTimer3(hz);
}

void Timers::setTimer3func(void (*timer3func) (void)) {
    Timers::timer3func = timer3func;
}

void Timers::runTimer3func() {
    Timers::timer3func();
}

void Timers::initTimer3(int numhz){
...
int Timers::hztobitnumbers(int numhz) {
    bool cs32bit = numhz < 4;
    bool cs31bit = 244 > numhz && numhz >= 4;
    bool cs30bit = !( (244 > numhz && numhz > 31) ||
                    (4 > numhz && numhz > 0.95) );
...
float Timers::bitnumbertoprescale(int bitnumber) {
